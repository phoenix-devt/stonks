...
public class SharePaper extends CustomItem<Share> {
    ...
    public Placeholders getPlaceholders(Player player, Share share) {
        ...
        placeholders.register("amount", Utils.fourDigits.format(share.getAmount()));
    ...
    public void whenBuilt(ItemStack item, ItemMeta meta, Share share) {
        ...
        nbt.set(Utils.namespacedKey("ShareAmount"), PersistentDataType.DOUBLE, share.getAmount());
        nbt.set(Utils.namespacedKey("ShareLeverage"), PersistentDataType.DOUBLE, share.getLeverage());
