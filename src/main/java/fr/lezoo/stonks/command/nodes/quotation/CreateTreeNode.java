...
public class CreateTreeNode extends CommandTreeNode {
    ...
    public CommandResult execute(CommandSender sender, String[] args) {
        ...
        if (Stonks.plugin.quotationManager.has(args[2])) {
            sender.sendMessage(ChatColor.RED + "There is already a quotation with ID " + args[1]);
        ...
        Stonks.plugin.quotationManager.register(new CreatedQuotation(args[2], args[3], null, new QuotationInfo(System.currentTimeMillis(), initialPrice)));
